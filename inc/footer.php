            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 reponsive-mb30">
                    <div class="widget-logo">
                        <div id="logo-footer">
                            <a href="./" rel="home">
                                <img src="frontend/images/logo.png" alt="image" style="height: 50px">
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 reponsive-mb30">
                    <div class="widget widget-out-link clearfix">
                        ...
                        <ul class="one-half">
                            ...
                            <li><a href="cryptocurrency">Cryptocurrency</a>
                            </li>
                            <li><a href="risk_and_rewards">Risk &amp; Rewards</a>
                            </li>
                        </ul>
                        <ul class="one-half">
                            <li><a href="affiliate_program">Affiliate Program</a>
                            <li><a href="safety_of_funds">Safety of funds</a></li>
                        </ul>
                    </div>
                </div>
                <!-- /.col-md-3 -->
                ...
                <div class="col-lg-3 col-sm-6 reponsive-mb30">
                    <div class="widget widget-recent-new">
                        ...
                        <ul class="popular-new">
                            <li>
                                <div class="text">
                                    <h6><a href="https://www.dailyfx.com/forex/fundamental/daily_briefing/session_briefing/daily_fundamentals/2018/04/05/us-dollar-catches-a-bid-ahead-of-non-farm-payrolls-nfp-srepstansl">US Dollar Catches a Bid Ahead of Non-Farm Payrolls (NFP)</a></h6>
                                    <span>5 April 2018</span>
                                </div>
                            </li>
                            <li>
                                <div class="text">
                                    <h6><a href="https://www.dailyfx.com/forex/fundamental/daily_briefing/daily_pieces/commodities/2018/03/30/Crude-Oil-Gold-Prices-Positioned-for-Weakness-Into-Holiday-Lulll">Crude Oil, Gold Prices Positioned for Weakness</a></h6>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    <div class="copyright">
                        <p>Copyright &copy; 2018. All rights reserved. Rocknetfx Ltd <!--a href="#"> Legal</a-->
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6">
