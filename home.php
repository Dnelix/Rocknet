        ...
        <div id="rev_slider_1078_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
            ...
            <ul>
                ...
                <li data-index="rs-3050" data-transition="fade" data-slotamount="7" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000" data-rotate="0" data-saveperformance="off" data-title="Ken Burns"
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="frontend/images/slides/22.jpg" alt="" data-bgposition="center center" data-kenburns="off" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0"
                         data-bgparallax="10" class="rev-slidebg" data-no-retina>

                    <div class="section-overlay style2" style="opacity: 0.5 !important;"></div>
                    <!-- LAYERS -->
                    <!-- LAYER NR. 12 -->
            ...
            <div class="row">
                <div class="col-lg-4 flat-icon-left">
                    ...
                    <div class="iconbox iconleft">
                        ...
                        <div class="box-content">
                            <h5 class="box-title">No Hidden Charges</h5>
                            <p>Just a one time fee, and you get your full investment returns. We don't cut corners</p>
                        </div>
                    </div>
                    ...
                    <div class="iconbox iconleft">
                        ...
                        <div class="box-content">
                            <h5 class="box-title">Retirement Income</h5>
                            <p>Forecasts retirement spending by using your current spending and adjusting for age</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
                ...
                <div class="col-lg-4 flat-icon-right">
                    ...
                    <div class="iconbox iconleft">
                        ...
                        <div class="box-content">
                            <h5 class="box-title">Investment Returns</h5>
                            <p>Forecasts returns and rewards for the trades and investments you make using our proprietary model</p>
                        </div>
                    </div>
                    <div class="divider sh5"></div>
                    <div class="iconbox iconleft">
                        ...
                        <div class="box-content">
                            ...
                            <p>Get the best actions on your investments. We handle tax-loss harvesting and dividend reinvesting</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <article class="pricing-item text-center wrap-iconbox">
                            <div class="header-pricing">
                                ...
                                <div class="flat-value">
                                    ...
                                    <span class="price-number">3,000</span>
                                    <span class="price-month">min</span>
                                </div>
                            </div>
                            <ul class="pricing-content">
                                <li style="width: 100%">Investor type: Virgin</li>
                                <li style="width: 100%">Contract (TF) : 30 days</li>
                                <li style="width: 100%">Referral Bonus: 3%</li>
                ...
                <div class="col-lg-4">
                    <div class="padding-lr35">
                        <article class="pricing-item active text-center wrap-iconbox">
                            ...
                            <ul class="pricing-content">
                                <li style="width: 100%">Investor type: Passive</li>
                                <li style="width: 100%">Contract (TF) : 30 Days</li>
                                <li style="width: 100%">Referral Bonus: 5%</li>
                ...
                <div class="col-lg-4">
                    <div class="padding-lr5_65">
                        <article class="pricing-item text-center wrap-iconbox">
                            ...
                            <ul class="pricing-content">
                                <li style="width: 100%">Investor type: Aggressive</li>
                                <li style="width: 100%">Contract (TF) : 30 Days</li>
                                <li style="width: 100%">Referral Bonus: 7%</li>
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="wrap-formrequest padding-lr100">
                        <form id="contactform" class="contactform wrap-form style3 clearfix" method="post" action="https://rocknetfx.com/contact/contact-process2.php" novalidate="novalidate">
                            ...
                            <ul class="slides">
                                ...
                                <li>
                                    <div class="testimonials style3 text-center">
                                        <div class="message">
                                            <blockquote class="whisper">
                                                "I am very satisfied with the advice provided by Alex Doyle. He listened sensitively and quickly assessed the types of risk I was prepared to take. Alex demonstrated that he understood my situation and my needs and advised accordingly."
                                            </blockquote>
                                        </div>
                                        <div class="avatar">
                                ...
                                <li>
                                    <div class="testimonials style3 text-center">
                                        <div class="message">
                                            <blockquote class="whisper">
                                                "Rocknetfx have professionally handled my pension and investments over a long period. Day trading can be a daunting world, but their service has always been friendly, targeted, and clear – somehow they always find a way of demystifying the process.
                                                Highly recommended."
                                            </blockquote>
                                        </div>
                                        <div class="avatar">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="title-section style2 color-white titlesize48">
                        <h1 class="title"><span>What is Bitcoin?</span></h1>
                        <h1 class="title">A New Kind of Money</h1>
                        <div class="sub-title style2 linehight30" style="width: 60%;">
